...
# Loading data ------------------------------------------------------------
dbSendQuery(conn,"copy censos.census2021_ci2 (CENSUS_YEAR,DGUID,ALT_GEO_CODE,GEO_LEVEL,GEO_NAME,TNR_SF,
TNR_LF,DATA_QUALITY_FLAG,CHARACTERISTIC_ID,CHARACTERISTIC_NAME,
CHARACTERISTIC_NOTE,C1_COUNT_TOTAL,
SYMBOL1,\"C2_COUNT_MEN+\",
SYMBOL2,\"C3_COUNT_WOMEN+\",
SYMBOL3,C4_COUNT_LOW_CI_TOTAL,
SYMBOL4,\"C5_COUNT_LOW_CI_MEN+\",
SYMBOL5,\"C6_COUNT_LOW_CI_WOMEN+\",
SYMBOL6,C7_COUNT_HI_CI_TOTAL,
SYMBOL7,\"C8_COUNT_HI_CI_MEN+\",
SYMBOL8,\"C9_COUNT_HI_CI_WOMEN+\",
SYMBOL9,C10_RATE_TOTAL,
SYMBOL10,\"C11_RATE_MEN+\",
SYMBOL11,\"C12_RATE_WOMEN+\",
SYMBOL12,C13_RATE_LOW_CI_TOTAL,
SYMBOL13,\"C14_RATE_LOW_CI_MEN+\",
SYMBOL14,\"C15_RATE_LOW_CI_WOMEN+\",
SYMBOL15,C16_RATE_HI_CI_TOTAL,
SYMBOL16,\"C17_RATE_HI_CI_MEN+\",
SYMBOL17,\"C18_RATE_HI_CI_WOMEN+\",
SYMBOL18)
FROM PROGRAM '7z e -so C:/CEDEUS/2022/dec01_bbddSina_KasraPaper/input/98-401-X2021006CI_eng_CSV/csv_ddbb/merged-csv-files.7z' DELIMITER ',' CSV HEADER encoding 'windows-1251';")

#Big Query creates more rows that the sum of each table